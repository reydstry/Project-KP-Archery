...
<div class="space-y-4" x-data="attendanceInputPage({{ (int) $sessionId }})" x-init="init()">
    ...
    <div class="bg-white border border-slate-200 rounded-xl p-4 sm:p-5 space-y-3">
        ...
        <div class="flex items-center justify-between gap-3">
            ...
            <button type="button" @click="submitAttendance()" :disabled="submitting || selectedMemberIds.length === 0" class="px-4 py-2.5 rounded-lg text-white bg-emerald-600 hover:bg-emerald-700 disabled:bg-slate-300 text-sm font-semibold">
...
function attendanceInputPage(sessionId) {
    return {
        ...
        async submitAttendance() {
            ...
            try {
                await window.API.post(`/admin/training-sessions/${this.sessionId}/attendances`, {
