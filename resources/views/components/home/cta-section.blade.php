<section class="py-12 sm:py-16 md:py-20 bg-gradient-to-br from-blue-100 via-pink-100 to-blue-50 relative overflow-hidden">
    <!-- Decorative Elements -->
    <div class="absolute inset-0 opacity-10">
        <div class="absolute top-10 left-10 w-72 h-72 bg-blue-400 rounded-full blur-3xl"></div>
        <div class="absolute bottom-10 right-10 w-96 h-96 bg-pink-400 rounded-full blur-3xl"></div>
    </div>
    ...
    <div class="container mx-auto px-4 relative z-10">
        <div class="max-w-4xl mx-auto text-center">
            ...
            <h2 class="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold mb-4 sm:mb-6 px-4 text-gray-800">
                Siap Memulai Perjalanan Panahanmu?
            </h2>

            <!-- Subtitle -->
            <p class="text-base sm:text-lg md:text-xl mb-6 sm:mb-8 px-4 text-gray-600">
                Bergabunglah dengan komunitas panahan kami dan rasakan pengalaman belajar yang profesional bersama instruktur bersertifikat.
            </p>
