<section id="beranda"
    ...
    <div class="relative z-20 max-w-4xl px-6 text-center">
        ...
        <p class="mt-8 text-gray-100 text-lg md:text-xl leading-relaxed max-w-3xl mx-auto">
        ...
        <div class="mt-10 flex flex-col sm:flex-row justify-center gap-4">
            <!-- PRIMARY BUTTON -->
            <a href="#program"
                class="px-10 py-4 bg-gradient-to-r from-blue-500 to-red-500 text-white font-bold rounded-full text-lg
            ...
            <!-- SECONDARY BUTTON -->
            <a href="#kontak"
                class="px-10 py-4 bg-white text-gray-800 font-bold rounded-full text-lg
