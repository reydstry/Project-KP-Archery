<section id="program" class="py-20 bg-gradient-to-br from-blue-100 via-pink-100 to-blue-50">
    <div class="container mx-auto px-4">
        ...
        <div class="text-center mt-12">
            <a href="#semua-program" class="inline-block px-10 py-4 bg-gradient-to-r from-blue-600 to-red-600 text-white font-bold rounded-full hover:from-blue-700 hover:to-red-700 transition-all duration-300 shadow-xl hover:scale-105">
                Lihat Semua Program
            </a>
        </div>
    </div>
