<div class="bg-white rounded-2xl shadow-lg p-8">
    <h3 class="text-2xl font-bold text-gray-800 mb-6">{{ __('contact.send_message_title') }}</h3>
    ...
    <form id="contactForm" onsubmit="return false;" class="space-y-5">
        ...
        <div>
            <label for="program" class="block text-sm font-medium text-gray-700 mb-2">
                {{ __('contact.program_interest') }} <span class="text-red-500">*</span>
            </label>
            <select 
                id="program" 
                name="program" 
                ...
                class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-transparent transition-all duration-200"
            >
                <option value="">{{ __('contact.select_program') }}</option>
                <option value="pemula">{{ __('contact.program_beginner') }}</option>
                <option value="menengah">{{ __('contact.program_intermediate') }}</option>
                <option value="advanced">{{ __('contact.program_advanced') }}</option>
                <option value="kompetisi">{{ __('contact.program_competition') }}</option>
                <option value="privat">{{ __('contact.program_private') }}</option>
            </select>
        </div>
