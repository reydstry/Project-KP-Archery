    ...
    <div class="container mx-auto px-6 relative z-10">
        ...
        <div class="grid md:grid-cols-2 gap-8 max-w-3xl mx-auto mb-16">
            ...
            <div class="relative group">
                <!-- Glow -->
                <div class="absolute inset-0 bg-{{ $package['color'] }}-500/20 rounded-3xl blur-2xl scale-105 pointer-events-none opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
