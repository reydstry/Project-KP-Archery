    ...
    <div class="container mx-auto px-6 relative z-10">
        ...
        <div class="grid md:grid-cols-3 gap-6 max-w-5xl mx-auto">
            ...
            <div class="relative group">
                <!-- Glow -->
                <div class="absolute inset-0 bg-{{ $schedule['color'] }}-500/20 rounded-3xl blur-2xl scale-105 pointer-events-none opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
