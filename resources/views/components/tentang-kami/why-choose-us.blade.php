    ...
    <div class="container mx-auto px-6 relative z-10">
        ...
        <div class="grid sm:grid-cols-2 md:grid-cols-3 gap-6 sm:gap-8 max-w-5xl mx-auto">
            ...
            <div class="relative group">
                ...
                <!-- Card -->
                <div class="relative h-full bg-{{ $card['color'] }}/15 backdrop-blur-[2px] border border-white/20 rounded-2xl overflow-hidden
                    ...
                    <div class="bg-{{ $card['color'] }}/40 border-b
                     border-white/10 px-6 py-5 flex items-center gap-3">
                        <!-- Icon -->
                        <div class="w-11 h-11 bg-[#a72320]/70 backdrop-blur-sm border border-white/20 rounded-2xl 
