        ...
        <aside class="fixed top-0 left-0 h-screen w-64 brand-dark-bg text-white border-r border-slate-800 z-50 transition-transform duration-300"
            ...
            <div class="h-full flex flex-col">
                ...
                <nav class="flex-1 p-3 space-y-1 overflow-y-auto">
                    ...
                    <a href="{{ route('coach.bookings.create') }}" @click="if(isMobile) sidebarOpen = false"
                       class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition {{ request()->routeIs('coach.bookings.*') ? 'bg-[#1a307b] text-white' : 'text-slate-300 hover:bg-slate-800 hover:text-white' }}">
