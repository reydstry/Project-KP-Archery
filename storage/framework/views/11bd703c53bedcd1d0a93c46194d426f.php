    ...
    <div class="container mx-auto px-4">
        <div class="flex items-center justify-between h-20 relative">
            ...
            <a href="/" class="hidden md:flex items-center">
                <img src="<?php echo e(asset('asset/img/logofocus.png')); ?>" alt="FocusOnex Archery" class="h-10 w-auto">
            </a>
            ...
            <div class="hidden md:flex items-center space-x-8">
                <a href="<?php echo e(route('beranda')); ?>" class="nav-link"><?php echo e(__('nav.home')); ?></a>
                <a href="<?php echo e(route('tentang-kami')); ?>" class="nav-link"><?php echo e(__('nav.about')); ?></a>
                <a href="<?php echo e(route('program')); ?>" class="nav-link"><?php echo e(__('nav.program')); ?></a>
                <a href="<?php echo e(route('galeri')); ?>" class="nav-link"><?php echo e(__('nav.gallery')); ?></a>
                <a href="<?php echo e(route('kontak')); ?>" class="nav-link"><?php echo e(__('nav.contact')); ?></a>
            </div>
            ...
            <div class="hidden md:flex items-center gap-4">
                ...
                <div class="relative">
                    ...
                    <div id="lang-menu"
                        ...
                        <a href="<?php echo e(route('language.switch', 'id')); ?>" class="block px-4 py-2 hover:bg-gray-100 <?php echo e(app()->getLocale() == 'id' ? 'bg-gray-100 font-semibold' : ''); ?>">ID</a>
                        <a href="<?php echo e(route('language.switch', 'en')); ?>" class="block px-4 py-2 hover:bg-gray-100 <?php echo e(app()->getLocale() == 'en' ? 'bg-gray-100 font-semibold' : ''); ?>">EN</a>
                    </div>
                </div>
...
<div id="mobile-menu" class="hidden fixed inset-0 bg-white z-50 p-6">
    ...
    <nav class="flex flex-col gap-6 text-lg font-medium">
        <a href="<?php echo e(route('beranda')); ?>" class="text-gray-700 hover:text-gray-900"><?php echo e(__('nav.home')); ?></a>
        <a href="<?php echo e(route('tentang-kami')); ?>" class="text-gray-700 hover:text-gray-900"><?php echo e(__('nav.about')); ?></a>
        <a href="<?php echo e(route('program')); ?>" class="text-gray-700 hover:text-gray-900"><?php echo e(__('nav.program')); ?></a>
        <a href="<?php echo e(route('galeri')); ?>" class="text-gray-700 hover:text-gray-900"><?php echo e(__('nav.gallery')); ?></a>
        <a href="<?php echo e(route('kontak')); ?>" class="text-gray-700 hover:text-gray-900"><?php echo e(__('nav.contact')); ?></a>
    </nav>
    ...
    <div class="mt-10 flex flex-col gap-4">
        ...
        <div class="flex justify-center gap-3">
            <a href="<?php echo e(route('language.switch', 'id')); ?>" class="px-4 py-2 rounded-md <?php echo e(app()->getLocale() == 'id' ? 'bg-gray-800 text-white' : 'bg-gray-100'); ?>">ID</a>
            <a href="<?php echo e(route('language.switch', 'en')); ?>" class="px-4 py-2 rounded-md <?php echo e(app()->getLocale() == 'en' ? 'bg-gray-800 text-white' : 'bg-gray-100'); ?>">EN</a>
        </div>
    </div>
</div>
...
<?php /**PATH D:\laragon\www\Project-KP-Archery\resources\views/components/global/navbar.blade.php ENDPATH**/ ?>