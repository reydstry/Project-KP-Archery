    ...
    <div class="container mx-auto px-4 relative z-10">
        <div class="max-w-4xl mx-auto text-center">
            ...
            <div class="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4 px-4">
                ...
                <a href="<?php echo e(route('program')); ?>" class="w-full sm:w-auto inline-flex items-center justify-center px-6 sm:px-8 py-3 sm:py-4 bg-white border-2 border-gray-300 text-gray-800 font-bold rounded-full hover:bg-gray-50 transition-all duration-300 shadow-xl hover:scale-105 text-sm sm:text-base">
...
<?php /**PATH D:\laragon\www\Project-KP-Archery\resources\views/components/home/cta-section.blade.php ENDPATH**/ ?>