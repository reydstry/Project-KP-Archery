        ...
        <aside class="fixed top-0 left-0 h-screen w-64 brand-dark-bg text-white border-r border-slate-800 z-50 transition-transform duration-300"
            ...
            <div class="h-full flex flex-col">
                ...
                <nav class="flex-1 p-3 space-y-1 overflow-y-auto">
                    <a href="<?php echo e(route('dashboard')); ?>" @click="if(isMobile) sidebarOpen = false"
                       class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition <?php echo e(request()->routeIs('dashboard') ? 'bg-[#1a307b] text-white' : 'text-slate-300 hover:bg-slate-800 hover:text-white'); ?>">
                    ...
                    <a href="<?php echo e(route('coach.attendance.index')); ?>" @click="if(isMobile) sidebarOpen = false"
                       class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition <?php echo e(request()->routeIs('coach.attendance.*') ? 'bg-[#1a307b] text-white' : 'text-slate-300 hover:bg-slate-800 hover:text-white'); ?>">
        ...
        <main class="flex-1 lg:ml-64 min-h-screen">
            ...
            <div class="px-4 sm:px-6 lg:px-8 py-5 sm:py-6">
                <div class="max-w-7xl mx-auto space-y-4">
                    <div>
                        <h2 class="text-xl sm:text-2xl font-bold text-slate-900"><?php echo $__env->yieldContent('title'); ?></h2>
                        <p class="text-sm text-slate-500 mt-1"><?php echo $__env->yieldContent('subtitle'); ?></p>
                    </div>
