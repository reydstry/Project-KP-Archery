    ...
    <div class="container mx-auto px-6 relative z-10">
        ...
        <div class="grid sm:grid-cols-2 xl:grid-cols-4 gap-6">
            ...
            <div class="relative group flex flex-col">
                ...
                <div class="absolute inset-0 rounded-3xl blur-xl scale-110 opacity-0 group-hover:opacity-100 transition-opacity duration-500 <?php echo e($product['bg']); ?> pointer-events-none"></div>
                ...
                <div class="relative flex flex-col h-full bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl overflow-hidden
                    ...
                    <div class="<?php echo e($product['bg']); ?> border-b border-white/10 px-6 py-5 flex items-center gap-3">
                        <div class="w-11 h-11 ring-2 <?php echo e($product['ring']); ?> rounded-2xl bg-white/10 flex items-center justify-center flex-shrink-0 shadow-inner">
...
<?php /**PATH C:\laragon\www\Project\club-panahan\resources\views/components/tentang-kami/toko.blade.php ENDPATH**/ ?>