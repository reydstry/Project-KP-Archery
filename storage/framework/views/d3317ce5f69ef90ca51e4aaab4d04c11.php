...
<section class="py-16 bg-gray-50">
    <div class="container mx-auto px-4">
        <div class="text-center mb-8">
            ...
            <h2 class="text-3xl font-bold text-gray-900 mb-3"><?php echo e(__('program.instructor_section_title')); ?></h2>
            <p class="text-gray-600 max-w-3xl mx-auto">
                <?php echo e(__('program.instructor_section_subtitle')); ?>
        ...
        <div class="max-w-4xl mx-auto space-y-6">
            ...
            <?php $__currentLoopData = $instructorPoints; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $point): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="bg-gradient-to-br from-blue-50 to-slate-50 rounded-lg p-6 shadow-md hover:shadow-lg transition-shadow border border-blue-100">
                <div class="flex items-start">
                    ...
                    <div>
                        <h3 class="text-lg font-bold text-gray-900 mb-2"><?php echo e($point['title']); ?></h3>
                        <p class="text-gray-700"><?php echo e($point['description']); ?></p>
                    </div>
                </div>
            </div>
...
<?php /**PATH D:\laragon\www\Project-KP-Archery\resources\views/components/program/instructor-section.blade.php ENDPATH**/ ?>