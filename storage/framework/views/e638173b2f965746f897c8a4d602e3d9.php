        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-10">
            ...
            <div class="relative group">
                ...
                <div class="relative h-full bg-white/5 backdrop-blur-[2px] border border-white/20 rounded-2xl overflow-hidden
                    ...
                    <!-- Card Header -->
                    <div class="bg-<?php echo e($program['color']); ?>-500/20 border-b
...
</section><?php /**PATH D:\laragon\www\Project-KP-Archery\resources\views/components/program/hero-section.blade.php ENDPATH**/ ?>