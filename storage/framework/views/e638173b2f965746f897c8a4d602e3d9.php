...
<section class="bg-gradient-to-br from-gray-50 to-white py-20 mt-20">
    <div class="container mx-auto px-4">
        <div class="text-center mb-12">
            <h1 class="text-4xl font-bold text-gray-900 mb-3"><?php echo e(__('program.hero_page_title')); ?></h1>
            <p class="text-gray-600"><?php echo e(__('program.hero_page_subtitle')); ?></p>
        </div>
        ...
        <div class="grid md:grid-cols-4 gap-6 mb-8">
            ...
            <div class="bg-white rounded-lg overflow-hidden shadow-md hover:shadow-xl transition-shadow">
                <!-- Header dengan warna -->
                <div class="<?php echo e($program['bg']); ?> text-white px-6 py-5 flex items-center">
                    <div class="mr-3">
                        <?php echo $program['icon']; ?>

                    </div>
                    <h3 class="text-base font-bold leading-tight"><?php echo e($program['title']); ?></h3>
                </div>
                
                <!-- Body dengan background putih -->
                <div class="p-6 bg-gray-50">
                    <p class="text-sm text-gray-700 mb-5 leading-relaxed"><?php echo e($program['description']); ?></p>
        ...
        <div class="bg-blue-600 text-white rounded-xl p-6 text-center shadow-lg">
            <h3 class="text-2xl font-bold mb-2"><?php echo e(__('program.registration_fee')); ?></h3>
            <p class="text-3xl font-bold">Rp 200.000,-</p>
        </div>
    </div>
</section>
<?php /**PATH D:\laragon\www\Project-KP-Archery\resources\views/components/program/hero-section.blade.php ENDPATH**/ ?>